...
$lang = array_merge($lang, array(
	...
	'MARK_ALL_READ'			=> 'Отметить всё: прочтено',
	'MARK_FORUMS_READ'		=> 'Отметить форумы: прочтено',
	'MARK_READ'				=> 'Отметить как прочтённое',
	'MARK_SUBFORUMS_READ'	=> 'Отметить подфорумы: прочтено',
	'MB'					=> 'MБ',
	'MIB'					=> 'МБ',
	...
	'RULES_ATTACH_CAN'			=> '<strong>?</strong> добавлять вложения',
	'RULES_ATTACH_CANNOT'		=> '<strong>✗</strong> добавлять вложения - нет',
	'RULES_DELETE_CAN'			=> '<strong>?</strong> удалять свои сообщения',
	'RULES_DELETE_CANNOT'		=> '<strong>✗</strong> удалять свои сообщения - нет',
	'RULES_DOWNLOAD_CAN'		=> '<strong>?</strong> скачивать вложения',
	'RULES_DOWNLOAD_CANNOT'		=> '<strong>✗</strong> скачивать вложения - нет',
	'RULES_EDIT_CAN'			=> '<strong>?</strong> редактировать свои сообщения',
	'RULES_EDIT_CANNOT'			=> '<strong>✗</strong> редактировать свои сообщения - нет',
	'RULES_LOCK_CAN'			=> '<strong>?</strong> закрывать свои темы',
	'RULES_LOCK_CANNOT'			=> '<strong>✗</strong> закрывать свои темы - нет',
	'RULES_POST_CAN'			=> '<strong>?</strong> начинать темы',
	'RULES_POST_CANNOT'			=> '<strong>✗</strong> начинать темы - нет',
	'RULES_REPLY_CAN'			=> '<strong>?</strong> отвечать на сообщения',
	'RULES_REPLY_CANNOT'		=> '<strong>✗</strong> отвечать на сообщения - нет',
	'RULES_VOTE_CAN'			=> '<strong>?</strong> голосовать в опросах',
	'RULES_VOTE_CANNOT'			=> '<strong>✗</strong> голосовать в опросах - нет',
